        ...
        <div class="grid gap-4">
            @foreach ($appointments as $appointment)
                <div class="bg-white rounded-xl shadow-md p-6 flex justify-between items-center">
                    <div>
                        <h4 class="font-bold text-lg">{{ $appointment->service }} ({{ ucfirst($appointment->gender) }})</h4>
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('appointments.edit', $appointment->id) }}" class="bg-yellow-400 hover:bg-yellow-500 text-white px-4 py-2 rounded-lg text-sm">Edit</a>
